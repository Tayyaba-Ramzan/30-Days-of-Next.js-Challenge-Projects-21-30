...
export default function QuizApp() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-background text-foreground border">
      {state.showResults ? (
        ...
        <div className="bg-card p-8 rounded-lg shadow-md w-full max-w-md border border-slate-800">
          <h2 className="text-2xl font-bold mb-4">
            <h1 className="text-5xl italic font-bold text-center mb-6">Quiz App</h1>
